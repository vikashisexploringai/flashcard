const paperI2021Theme = {
    ...
    flashcards: [
        ...
        {
    question: "Evaluate the nature of Bhakti literature and its contribution to Indian culture",
    paragraph: `Bhakti literature, emerging between the 7th and 17th centuries, reflects a devotional movement that transcended ritualistic practices and emphasized personal devotion to a deity. Composed in regional languages by saints like Kabir, Mirabai, Tulsidas, and Alvars-Nayanars, it democratized spiritual expression and made religion accessible to the masses. Its emphasis on love, equality, and inner purity challenged caste hierarchies and religious orthodoxy, fostering a sense of unity across communities.

Culturally, Bhakti literature enriched Indian art, music, and poetry. It influenced classical and folk traditions, devotional music like bhajans and kirtans, and inspired temple architecture and festivals. Philosophically, it bridged the gap between the divine and the individual, shaping the spiritual outlook of Indian society. By promoting vernacular languages, it laid the foundation for modern Indian literature and nurtured a shared cultural identity that continues to resonate across India’s diverse social fabric.`
        },
        {
    ...
    paragraph: `The socio-religious reform movements of 19th-century India emerged in response to colonial influence, Western education, and growing awareness of social evils. These movements aimed to modernize society by eradicating regressive practices like caste discrimination, sati, child marriage, and promoting education, gender equality, and rational thinking.

The Brahmo Samaj, founded by Raja Ram Mohan Roy in 1828, played a pioneering role. It advocated monotheism, condemned idol worship, and emphasized reason and ethics in religion. It campaigned against social evils and supported widow remarriage and women’s education. Successive leaders like Debendranath Tagore and Keshab Chandra Sen further expanded its influence.

Young Bengal, led by Henry Derozio, was a radical intellectual movement of students from Hindu College. They championed rationalism, secularism, and individual liberty, questioning orthodox Hindu traditions. Though short-lived, it sparked a spirit of inquiry and laid the foundation for future reformist thought.

Together, these movements challenged orthodoxy, inspired modern Indian thought, and laid the groundwork for national awakening.`
        },
        {
    ...
    paragraph: `The integration of over 560 princely states after independence posed complex administrative and socio-cultural challenges. Administratively, there was no uniform governance, as each state had its own laws, revenue systems, and administrative structures. Bringing them under the Indian Union required the creation of interim arrangements like Covenant States and the appointment of Rajpramukhs. The States Reorganisation Commission (1956) was later formed to reorganize states on linguistic lines, streamlining governance but also stirring identity politics.
...
Reclaimed areas reduce permeable surfaces, limiting rainwater absorption and contributing to urban heat island effects. Groundwater levels also decline due to the loss of recharge zones. Moreover, reclamation destroys habitats for aquatic and migratory species, reducing urban ecological diversity.
...
Geologically, India sits on its own tectonic plate—the Indian Plate—which collided with the Eurasian Plate to form the Himalayas. This gives it a separate structural identity from the rest of Asia.
...
Unlike mainstream systems that prioritize formal education and scientific validation, tribal knowledge emphasizes practical experience, community participation, and spiritual connection with nature. For instance, their traditional medicine, based on herbs and biodiversity, is effective and sustainable, though often undervalued by modern science.
...
They introduced political awakening among the educated middle class by promoting values of liberty, democracy, and civil rights. Through petitions, resolutions, and press campaigns, they questioned colonial policies and exposed economic exploitation, particularly through the Drain Theory articulated by Dadabhai Naoroji. Their demands for civil services reform, separation of judiciary from executive, and greater Indian representation laid the framework for political discourse.

Importantly, the Moderates fostered the idea of India as a nation, uniting people across regions, religions, and languages. They established the culture of debate and constitutional protest, which later movements built upon. They also created platforms like the Indian National Congress, which became the core of future mass movements.
...
During the Non-Cooperation Movement, Gandhi emphasized boycott of foreign goods, promotion of Khadi, and national education. He encouraged the use of Charkha to promote self-reliance, revive the rural economy, and instill dignity in manual labor. Gandhi stressed the removal of untouchability, Hindu-Muslim unity, and promotion of vernacular languages, planting the seeds of a socially inclusive movement.
...
In countries like Germany, Italy, and Spain, democratic institutions failed to address the mass unemployment, inflation, and loss of national pride. This vacuum allowed the rise of authoritarian leaders like Hitler, Mussolini, and Franco, who promised stability, national revival, and order. These regimes dismantled democratic structures, suppressed dissent, and promoted aggressive nationalism and militarism.

Meanwhile, communist ideology took root in the Soviet Union under Stalin, which, though not fascist, also rejected liberal democracy. The world became ideologically divided between democracies, fascist states, and communist regimes, eroding the global appeal of the democratic model.
...
North-south aligned ranges include the Rockies in North America and the Andes in South America. These ranges act as climatic barriers, influencing the movement of air masses and precipitation. For instance, the Andes block moist winds from the Atlantic, contributing to the aridity of the Atacama Desert on the western coast. Similarly, the Rockies intercept westerlies, causing rain shadow conditions in regions like the Great Plains.

East-west aligned ranges include the Himalayas, Alps in Europe, and Atlas Mountains in North Africa. These tend to intercept moist winds from adjacent oceans, causing orographic rainfall on windward slopes and dry conditions on leeward sides. The Himalayas trap monsoonal winds, leading to heavy rainfall on their southern slopes and arid conditions in Tibet to the north. They also block cold Central Asian winds, keeping northern India warmer in winter.
...
The Arctic, an ocean surrounded by land, is experiencing rapid sea ice loss due to rising temperatures. This leads to a weakened polar jet stream, causing more frequent and prolonged extreme weather events such as heatwaves, cold spells, and unseasonal storms in North America, Europe, and Asia. The reduced ice cover also leads to greater solar absorption, accelerating warming in a feedback loop. Melting permafrost in the Arctic releases methane, a potent greenhouse gas, intensifying climate change.

In contrast, Antarctica, a landmass surrounded by ocean, mainly contributes to sea level rise through melting glaciers, particularly in West Antarctica. The melting disrupts Southern Ocean circulation, which can alter global ocean currents and monsoon systems, potentially weakening nutrient upwelling and affecting marine biodiversity. However, Antarctica has less direct influence on daily weather patterns in populated regions compared to the Arctic.
...
Economically, oil-rich countries such as Saudi Arabia, Russia, and the United States benefit from export revenues, enabling them to build infrastructure, sovereign wealth funds, and global influence. In contrast, oil-importing nations—especially in South Asia and Sub-Saharan Africa—face high import bills, trade imbalances, and vulnerability to price shocks, affecting their economic stability.

Politically, the concentration of oil reserves in geopolitically sensitive regions like the Middle East often leads to power rivalries, external interventions, and conflicts, as seen in Iraq and Syria. Oil becomes a tool of diplomacy and pressure, influencing international relations and alliances.

Strategically, dependence on limited oil-producing regions makes global supply chains vulnerable to disruptions from wars, sanctions, or natural disasters. This has led countries to diversify energy sources, maintain strategic petroleum reserves, and invest in alternative energy technologies.

Environmentally, extraction and transportation in ecologically sensitive regions—like the Arctic or rainforests—lead to oil spills, habitat destruction, and carbon emissions, worsening the climate crisis. Meanwhile, oil dependency delays the transition to cleaner energy.
...
ThemeLoader.registerTheme(paperI2021Theme);

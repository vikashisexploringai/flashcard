...
Thus, while India’s collegium protects independence, it suffers from opacity; the U.S. system promotes transparency but risks politicisation. A balanced reform model for India would preserve independence while enhancing transparency and objective selection criteria.`
    ...
    paragraph: `The evolving pattern of Centre-State financial relations in India, shaped by planned development, reflects a persistent trend of centralization, albeit with recent reforms attempting to rebalance fiscal federalism.

Evolution in the Context of Planned Development:

The era of planned development, initiated with the Five-Year Plans, cemented the Centre's dominance. The Planning Commission, a non-constitutional body, became the principal architect of national priorities and the allocator of resources to states. This created a channel of funds outside the Finance Commission's recommendations, making states financially dependent on the Centre for plan assistance. The centralization of major tax powers (like Income Tax and Excise Duties) and the proliferation of centrally sponsored schemes (CSS) further constrained states' fiscal autonomy, tailoring their development agendas to national blueprints rather than local needs.

Impact of Recent Reforms:

Recent reforms have significantly impacted this dynamic, with mixed outcomes for fiscal federalism:
...
In conclusion, while recent reforms have moved towards a more collaborative model, the fundamental asymmetry in financial power persists. The shift is more in process than in the substantive redistribution of fiscal sovereignty, and the goal of a balanced fiscal federation remains a work in progress.`
    ...
    paragraph: `Environmental pressure groups are non-governmental organizations (NGOs) and citizen collectives that advocate for environmental protection, conservation, and sustainable development. They operate outside formal government structures but aim to influence public opinion and policy through research, lobbying, campaigns, and direct action.

In India, these groups play a multi-faceted role:

1. Raising Awareness: They are crucial in translating complex environmental issues into public discourse. Through public campaigns, seminars, street plays, and strategic use of media (including social media), they highlight threats like air pollution, deforestation, and wildlife crime. Groups like the Centre for Science and Environment (CSE) publish extensive research, making scientific data accessible to the public and press, thereby fostering an informed citizenry.

2. Influencing Policies: Pressure groups act as a watchdog and a lobby. They engage in policy advocacy by submitting expert opinions to parliamentary committees, drafting model legislation, and lobbying with lawmakers. For instance, the sustained advocacy by groups like Kalpavriksh was instrumental in the enactment of the Forest Rights Act (2006) and the strengthening of the Wildlife Protection Act.

3. Advocating for Protection: They often resort to judicial activism, using the judiciary to enforce environmental laws. The Supreme Court's landmark interventions on issues like Delhi's air pollution (M.C. Mehta cases) and the protection of forests were largely triggered by petitions from environmental activists and groups. They also mobilize grassroots resistance against specific destructive projects, as seen in the iconic struggle against the Sardar Sarovar Dam (Narmada Bachao Andolan) and in numerous movements against mining projects.
...
In essence, India's foreign policy will be a dynamic tool to build a resilient energy ecosystem—balancing traditional suppliers with new partners, fossil fuels with renewables, and transactional deals with long-term strategic investments to fuel its economic growth.`
    ...
    paragraph: `The statement accurately captures the core political deadlock plaguing United Nations reform, particularly regarding the Security Council (UNSC). The \"delicate imbalance\" and \"entanglement\" refer to the fundamental clash between the established post-WWII power structure and the contemporary geopolitical realities, creating an intractable East-West policy confrontation.

East-West Policy Confrontations:

1. The Core Issue: Security Council Expansion: The primary battleground is the expansion of the UNSC. The \"West,\" led by the G4 nations (India, Japan, Germany, Brazil), argues for expansion in both permanent and non-permanent categories to make the Council more representative, legitimate, and effective. This is seen as a necessary update to the global power structure.

2. The Western (Status-Quo) Stance: The United States, while verbally supporting some reforms (like India's candidacy), is often ambivalent. It fears that a larger, more diverse UNSC could dilute its own influence and ability to act unilaterally. Its primary focus remains on maintaining the efficacy of the Council, often code for its own veto-wielding power.

3. The Russo-Chinese (Conservative) Stance: Russia and China, while part of the \"East\" in this context, are entrenched permanent members who benefit from the current system. They actively resist reforms that would dilute their privileged status and veto power. They often advocate for a broader consensus, a near-impossible threshold, effectively stalling the process. Their alliance aims to counterbalance Western, primarily US, influence within the UN system.

Critical Evaluation:

The confrontation is not a simple moral divide but a pragmatic struggle for power. The West's push for reform is viewed by Russia and China as a strategy to incorporate more US allies, thereby boxing them in. Conversely, the Russo-Chinese blockade is seen by the West and aspiring powers as an illegitimate attempt to cling to outdated privileges.

This deadlock has severe consequences. It erodes the UN's legitimacy and credibility, as it no longer reflects global power distributions. It paralyzes the UNSC on critical issues like Syria and Ukraine, reducing it to a forum for mutual vetoes rather than effective collective security.

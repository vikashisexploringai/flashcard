    ...
    flashcards: [
{
    ...
    (Keywords - Glacial Carving, Sea Flooding, Sheer Scale & Drama, Pristine Wilderness, and Tranquil Complexity)`,
...
1. Glacial Carving: During ice ages, massive glaciers flow down existing river valleys or tectonic fault lines. The immense weight and abrasive action of the ice (carrying rock debris) deepen, widen, and straighten these valleys into steep-sided, U-shaped troughs, often far below sea level.
2. Sea Flooding: As the glaciers later retreat (melt) due to climatic warming, the global sea level rises. The ocean invades and floods the deep, empty glacial troughs, creating long, narrow, and incredibly deep saltwater inlets.

Why They Are So Picturesque:

Fjords combine dramatic geological scales with serene beauty, creating world-renowned scenery:

1. Sheer Scale & Drama: Their defining feature is the stark contrast between towering, steep rock walls (often rising 1000+ meters vertically from the water) and the deep, placid blue or emerald waters below. This creates a breathtaking sense of grandeur and depth.
2. Pristine Wilderness: Found in remote, high-latitude regions (Norway, New Zealand, Chile, Canada), fjords are often surrounded by untouched landscapes—waterfalls cascading down cliffs, ancient glaciers clinging to mountains, and lush green vegetation at the water's edge.
...
In essence, auroras are a cosmic electrical phenomenon—a visual manifestation of Earth’s protective magnetosphere interacting with solar storms, transforming particle energy into ethereal light. They occur simultaneously in both hemispheres but are visible from different geographic locations.`
    ...
    paragraph: `Tsunamis are a series of exceptionally long-wavelength, high-speed ocean waves generated by the sudden displacement of a large volume of water, typically by seismic, volcanic, or gravitational events.

Formation and Triggers:

They form primarily in tectonically active zones, especially at subduction boundaries like the Pacific Ring of Fire. Key triggers include:

1. Submarine Earthquakes: Sudden vertical seafloor displacement during large quakes (e.g., the 2004 Indian Ocean Tsunami from a magnitude 9.1 quake off Sumatra).
2. Submarine Landslides: Underwater slope failures, often quake-triggered (e.g., a contributing factor in the 2018 Palu, Indonesia tsunami).
3. Volcanic Activity: Collapses or explosive eruptions (e.g., the 1883 Krakatoa eruption).
4. Coastal Collapses: Large-scale landslides into the sea (e.g., the 1958 Lituya Bay mega-tsunami).
